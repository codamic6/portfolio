  ...
  return (
    <section id="skills" className="py-20 md:py-32 bg-secondary/50">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-center font-headline text-3xl md:text-4xl font-bold mb-12">My Skills</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 max-w-5xl mx-auto">
          {skills.map((skill, index) => (
            <div key={index} className="animate-in fade-in zoom-in-95 duration-500" style={{ animationDelay: `${index * 100}ms`, animationFillMode: 'backwards' }}>
              <Card className="flex flex-col items-center justify-center p-6 text-center h-full shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
